...
public JUnitRestDocumentation restDocumentation =
		new JUnitRestDocumentation(BuildTool.MAVEN);
----
...
@Rule
public JUnitRestDocumentation restDocumentation =
		new JUnitRestDocumentation(BuildTool.GRADLE);
----
...
private ManualRestDocumentation restDocumentation =
		new ManualRestDocumentation(BuildTool.MAVEN);
----
...
----
private ManualRestDocumentation restDocumentation =
		new ManualRestDocumentation(BuildTool.GRADLE);
----
